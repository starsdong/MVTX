...
void makePlot()
{
  ...
  TLegend *leg = new TLegend(0.45, 0.18, 0.96, 0.34);
  leg->SetFillColor(10);
  leg->SetFillStyle(10);
  ...
  TLatex *tex = new TLatex(4.5, 3000, "Au + Au @ 200 GeV");
  tex->SetTextFont(42);
  tex->SetTextSize(0.05);
  tex->Draw("same");

  TLatex *tex = new TLatex(6.5, 1500, "10B 0-10%");
  tex->SetTextFont(42);
  tex->SetTextSize(0.05);
  tex->Draw("same");

  c1->Update();
  c1->SaveAs("fig/D0_10B.eps");
  c1->SaveAs("fig/D0_10B.png");
