...
HIST3* setHisto(HIST3* h, char* titlename, char* xtitle, char* ytitle,
               int optSize=1,
               double titleSize=0.05, double labelSize=0.05,
               int optOffset=1,
               double x_Offset=0.9, double y_Offset=1.6,
               int optRange=0,
...
//__________________________________________________________________________________________________________________
void setPad(TPad* pad, float left=0.16, float right=0.05, float top=0.05, float bottom=0.11, int nlogy=0, int nlogz=1)
{
    pad->SetLogy(nlogy);
    pad->SetLogz(nlogz);
    pad->SetFillColor(10);
