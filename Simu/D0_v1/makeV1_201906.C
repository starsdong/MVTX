...
void makeV1(const Bool_t sPHENIX=1)
{
  ...
  // STAR data points
  TGraphErrors *gr_D_STAR = new TGraphErrors("D0v1_QM18.txt","%lg %lg %lg");
  ...
  TGraphErrors *gr_Dbar_STAR = new TGraphErrors("D0barv1_QM18.txt","%lg %lg %lg");
  ...
  leg->AddEntry(gr_D_STAR,"D^{0} - STAR QM18","pl");
  leg->AddEntry(gr_Dbar_STAR,"#bar{D}^{0} - STAR QM18","pl");
  if(sPHENIX) {
